...
export declare const proxyMiddleware: (options: ProxyMiddlewareOptions, baseURL: string, injectBody: boolean) => (req: RequestWithRetry, res: Response, next: NextFunction) => Promise<void>;
export {};
